...
double windmillangle1 =0.0;
double windmillangle2=0.0;
int main() {    
    // Initialize GLFW
    if (!glfwInit()) {
...
//        lab1();
         simulateWindmill(new Point2D{400,300},100,windmillangle1,0.005);
         simulateWindmill(new Point2D{200,300},50,windmillangle2,0.05);//10x faster
        glEnd();
